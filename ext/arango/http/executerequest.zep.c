...
ZEPHIR_INIT_CLASS(Arango_Http_ExecuteRequest) {
	...
	ZEPHIR_REGISTER_INTERFACE(Arango\\Http, ExecuteRequest, arango, http_executerequest, arango_http_executerequest_method_entry);
 ...
 * @return Response
 */
ZEPHIR_DOC_METHOD(Arango_Http_ExecuteRequest, executeRequest);
